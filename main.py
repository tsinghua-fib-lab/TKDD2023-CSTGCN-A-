...
def parse_arguments(parser: ArgumentParser) -> Dict[str, Any]:
    ...
    parser.add_argument('--test_queries_path', type=str, default="./data_paper/data_QT_pred/test_queries.pkl", help="test_queries_dir")
    ...
    parser.add_argument('--dataset_source', type=str, default="./data_paper/data_QT/data_notbaseline/", help="")
    parser.add_argument('--dataset_source2', type=str, default="./data_paper/data_QT_pred/", help="")
    parser.add_argument('--dataset_roadid_length', type=str, default="./data_paper/data_QT_pred/roadid_length.pkl", help="")
